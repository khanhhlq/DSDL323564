...
#
# Script generated by Vivado on Tue Aug 25 23:51:06 +0700 2026
# SW Build 6511674 on Tue Jun 16 11:02:23 MDT 2026
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2026 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : up_down_counter_8bit_tb.sh
...
#
# Usage        : up_down_counter_8bit_tb.sh
#                up_down_counter_8bit_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                up_down_counter_8bit_tb.sh [-rerun]
#                up_down_counter_8bit_tb.sh [-reset_run]
#                up_down_counter_8bit_tb.sh [-clean]
#                up_down_counter_8bit_tb.sh [-reset_log]
#                up_down_counter_8bit_tb.sh [-help]
#
...
# script info
echo -e "up_down_counter_8bit_tb.sh - Script generated by export_simulation (Vivado v2026.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./up_down_counter_8bit_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot up_down_counter_8bit_tb xil_defaultlib.up_down_counter_8bit_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim up_down_counter_8bit_tb -key {Behavioral:sim_1:Functional:up_down_counter_8bit_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb up_down_counter_8bit_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./up_down_counter_8bit_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: up_down_counter_8bit_tb.sh [-help]\n\
Usage: up_down_counter_8bit_tb.sh [-step]\n\
Usage: up_down_counter_8bit_tb.sh [-lib_map_path]\n\
Usage: up_down_counter_8bit_tb.sh [-rerun]\n\
Usage: up_down_counter_8bit_tb.sh [-reset_run]\n\
Usage: up_down_counter_8bit_tb.sh [-clean]\n\
Usage: up_down_counter_8bit_tb.sh [-reset_log]\n\
Usage: up_down_counter_8bit_tb.sh [-keep_index]\n\
Usage: up_down_counter_8bit_tb.sh [-noclean_files]\n\n\
