...
#
# Script generated by Vivado on Wed Aug 26 08:11:38 +0700 2026
# SW Build 6511674 on Tue Jun 16 11:02:23 MDT 2026
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2026 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ck_div_50MHZ_to_5MHZ_tb.sh
...
#
# Usage        : ck_div_50MHZ_to_5MHZ_tb.sh
#                ck_div_50MHZ_to_5MHZ_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ck_div_50MHZ_to_5MHZ_tb.sh [-rerun]
#                ck_div_50MHZ_to_5MHZ_tb.sh [-reset_run]
#                ck_div_50MHZ_to_5MHZ_tb.sh [-clean]
#                ck_div_50MHZ_to_5MHZ_tb.sh [-reset_log]
#                ck_div_50MHZ_to_5MHZ_tb.sh [-help]
#
...
# script info
echo -e "ck_div_50MHZ_to_5MHZ_tb.sh - Script generated by export_simulation (Vivado v2026.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ck_div_50MHZ_to_5MHZ_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ck_div_50MHZ_to_5MHZ_tb xil_defaultlib.ck_div_50MHZ_to_5MHZ_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ck_div_50MHZ_to_5MHZ_tb -key {Behavioral:sim_1:Functional:ck_div_50MHZ_to_5MHZ_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ck_div_50MHZ_to_5MHZ_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ck_div_50MHZ_to_5MHZ_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ck_div_50MHZ_to_5MHZ_tb.sh [-help]\n\
Usage: ck_div_50MHZ_to_5MHZ_tb.sh [-step]\n\
Usage: ck_div_50MHZ_to_5MHZ_tb.sh [-lib_map_path]\n\
Usage: ck_div_50MHZ_to_5MHZ_tb.sh [-rerun]\n\
Usage: ck_div_50MHZ_to_5MHZ_tb.sh [-reset_run]\n\
Usage: ck_div_50MHZ_to_5MHZ_tb.sh [-clean]\n\
Usage: ck_div_50MHZ_to_5MHZ_tb.sh [-reset_log]\n\
Usage: ck_div_50MHZ_to_5MHZ_tb.sh [-keep_index]\n\
Usage: ck_div_50MHZ_to_5MHZ_tb.sh [-noclean_files]\n\n\
