...
#
# Script generated by Vivado on Wed Aug 26 01:03:43 +0700 2026
# SW Build 6511674 on Tue Jun 16 11:02:23 MDT 2026
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2026 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : DEM_8bit_tb.sh
...
#
# Usage        : DEM_8bit_tb.sh
#                DEM_8bit_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                DEM_8bit_tb.sh [-rerun]
#                DEM_8bit_tb.sh [-reset_run]
#                DEM_8bit_tb.sh [-clean]
#                DEM_8bit_tb.sh [-reset_log]
#                DEM_8bit_tb.sh [-help]
#
...
# script info
echo -e "DEM_8bit_tb.sh - Script generated by export_simulation (Vivado v2026.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./DEM_8bit_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DEM_8bit_tb xil_defaultlib.DEM_8bit_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DEM_8bit_tb -key {Behavioral:sim_1:Functional:DEM_8bit_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DEM_8bit_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./DEM_8bit_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: DEM_8bit_tb.sh [-help]\n\
Usage: DEM_8bit_tb.sh [-step]\n\
Usage: DEM_8bit_tb.sh [-lib_map_path]\n\
Usage: DEM_8bit_tb.sh [-rerun]\n\
Usage: DEM_8bit_tb.sh [-reset_run]\n\
Usage: DEM_8bit_tb.sh [-clean]\n\
Usage: DEM_8bit_tb.sh [-reset_log]\n\
Usage: DEM_8bit_tb.sh [-keep_index]\n\
Usage: DEM_8bit_tb.sh [-noclean_files]\n\n\
