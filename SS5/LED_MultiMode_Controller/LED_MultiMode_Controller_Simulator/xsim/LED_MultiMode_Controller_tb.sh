...
#
# Script generated by Vivado on Wed Sep 16 15:35:22 +0700 2026
# SW Build 6511674 on Tue Jun 16 11:02:23 MDT 2026
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2026 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : LED_MultiMode_Controller_tb.sh
...
#
# Usage        : LED_MultiMode_Controller_tb.sh
#                LED_MultiMode_Controller_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                LED_MultiMode_Controller_tb.sh [-rerun]
#                LED_MultiMode_Controller_tb.sh [-reset_run]
#                LED_MultiMode_Controller_tb.sh [-clean]
#                LED_MultiMode_Controller_tb.sh [-reset_log]
#                LED_MultiMode_Controller_tb.sh [-help]
#
...
# script info
echo -e "LED_MultiMode_Controller_tb.sh - Script generated by export_simulation (Vivado v2026.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./LED_MultiMode_Controller_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot LED_MultiMode_Controller_tb xil_defaultlib.LED_MultiMode_Controller_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim LED_MultiMode_Controller_tb -key {Behavioral:sim_1:Functional:LED_MultiMode_Controller_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb LED_MultiMode_Controller_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./LED_MultiMode_Controller_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: LED_MultiMode_Controller_tb.sh [-help]\n\
Usage: LED_MultiMode_Controller_tb.sh [-step]\n\
Usage: LED_MultiMode_Controller_tb.sh [-lib_map_path]\n\
Usage: LED_MultiMode_Controller_tb.sh [-rerun]\n\
Usage: LED_MultiMode_Controller_tb.sh [-reset_run]\n\
Usage: LED_MultiMode_Controller_tb.sh [-clean]\n\
Usage: LED_MultiMode_Controller_tb.sh [-reset_log]\n\
Usage: LED_MultiMode_Controller_tb.sh [-keep_index]\n\
Usage: LED_MultiMode_Controller_tb.sh [-noclean_files]\n\n\
