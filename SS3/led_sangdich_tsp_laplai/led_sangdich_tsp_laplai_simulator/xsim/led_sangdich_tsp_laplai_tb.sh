...
#
# Script generated by Vivado on Mon Sep 07 08:59:03 +0700 2026
# SW Build 6511674 on Tue Jun 16 11:02:23 MDT 2026
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2026 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : led_sangdich_tsp_laplai_tb.sh
...
#
# Usage        : led_sangdich_tsp_laplai_tb.sh
#                led_sangdich_tsp_laplai_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                led_sangdich_tsp_laplai_tb.sh [-rerun]
#                led_sangdich_tsp_laplai_tb.sh [-reset_run]
#                led_sangdich_tsp_laplai_tb.sh [-clean]
#                led_sangdich_tsp_laplai_tb.sh [-reset_log]
#                led_sangdich_tsp_laplai_tb.sh [-help]
#
...
# script info
echo -e "led_sangdich_tsp_laplai_tb.sh - Script generated by export_simulation (Vivado v2026.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./led_sangdich_tsp_laplai_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot led_sangdich_tsp_laplai_tb xil_defaultlib.led_sangdich_tsp_laplai_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim led_sangdich_tsp_laplai_tb -key {Behavioral:sim_1:Functional:led_sangdich_tsp_laplai_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb led_sangdich_tsp_laplai_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./led_sangdich_tsp_laplai_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: led_sangdich_tsp_laplai_tb.sh [-help]\n\
Usage: led_sangdich_tsp_laplai_tb.sh [-step]\n\
Usage: led_sangdich_tsp_laplai_tb.sh [-lib_map_path]\n\
Usage: led_sangdich_tsp_laplai_tb.sh [-rerun]\n\
Usage: led_sangdich_tsp_laplai_tb.sh [-reset_run]\n\
Usage: led_sangdich_tsp_laplai_tb.sh [-clean]\n\
Usage: led_sangdich_tsp_laplai_tb.sh [-reset_log]\n\
Usage: led_sangdich_tsp_laplai_tb.sh [-keep_index]\n\
Usage: led_sangdich_tsp_laplai_tb.sh [-noclean_files]\n\n\
