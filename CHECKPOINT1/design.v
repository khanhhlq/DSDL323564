module led_controller(
    ...
    wire [9:0] led_out1, led_out2, led_out3, led_out4, led_out_blink;
    ...
    led_blink lb(.clk(clk), .reset(reset), .clk_en(clk_en), .led_out(led_out_blink));
    ...
    always @(*) begin
        if (sw_test_manual) led_out <= led_out_blink;
            ...
            case (sw_mode)
                ...
                default: led_out <= 10'b0000_0000_00;
            endcase
        end
    end
endmodule